          ...
          <div className="px-2">
            ...
            {session?.user && (
              <motion.div
                ...
                className="flex items-center gap-3 mt-3 px-2 py-2.5 bg-gray-50 dark:bg-zinc-900/50 rounded-2xl border border-gray-100 dark:border-zinc-900"
              >
                {session.user.image ? (
                  <Image
              ...
              return (
                ...
                >
                  <Link
                    ...
                    onClick={() => setIsSideOpen(false)}
                    className={`
                      relative flex items-center gap-3 px-3.5 py-2.5 text-sm font-semibold rounded-2xl transition-colors duration-200
                      ${
                        isActive
                  ...
                  >
                    {isActive && (
                      <motion.span
                        ...
                        className="absolute inset-0 bg-orange-50 dark:bg-orange-950/20 rounded-2xl shadow-sm shadow-orange-500/5"
                        transition={{
                          type: "spring",
                          stiffness: 350,
                          damping: 30,
